...
import Navigation from "../(private)/recruitment/[single_recruit]/_ui/Navigation";
      ...
      <div className="rounded-md bg-white p-2">
        ...
        <Navigation
          navLinks={[
            {
              menu: "Screening",
              link: `/recruitment/${userProfile.id}/screening?query=personal_info`,
            },
            {
              menu: "Reference",
              link: `/recruitment/${userProfile.id}/reference`,
            },
            {
              menu: "Training",
              link: `/recruitment/${userProfile.id}/training`,
            },
          ]}
        />
      </div>
