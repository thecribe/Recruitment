...
const ManageCertificate = () => {
  ...
  return (
    <ModalWrapper>
      <ModalTrigger>
        <button className="text-sm w-fit bg-green-500/50 px-10 py-3.5 rounded-2xl cursor-pointer hover:bg-green-500/70 hover:scale-101 shadow-sm hover:shadow-black/30 active:shadow-black/10 active:scale-98 transition-all duration-300 flex items-center gap-1 ">
          <p className="text-sm">Manage Mandatory Certificates</p>
        </button>
      </ModalTrigger>
      <ModalContent
        className="h-fit max-h-[80%] w-[80%]"
        title={<FormTitle className="mb-0" label="Manage Certificates" />}
      >
          ...
          <div className="w-full lg:w-1/6 flex lg:flex-col divide-x-2 divide-gray-200">
            {["All certificates", "Add new certificate"].map(
              (eachNav, index) => {
                return (
                  <p
                    className="flex items-center gap-3 px-5 py-4 hover:bg-indigo-50 hover:text-indigo-700 rounded-2xl font-mediumduration-300 transition-all cursor-pointer"
                    key={index}
  ...
  const renderRow = (
    ...
    return (
      <tr
        ...
        className="border-b border-gray-200 even:bg-slate-200/30 hover:bg-blue-200/40 transition-all duration-300 cursor-pointer text-sm"
      >
            ...
            {type === "edit" ? (
              <div className="flex flex-col gap-2">
                ...
                <input
                  ...
                  className="outline-none border-2 border-gray-300 p-2 rounded-md text-sm "
                  id="certificate_name"
                ...
                <button
                  ...
                  className="text-sm w-fit bg-blue-500/50 px-10 py-3.5 rounded-2xl cursor-pointer hover:bg-blue-500/70 hover:scale-105 shadow-xs hover:shadow-black/30 active:shadow-black/10 active:scale-95 transition-all duration-300 mt-5"
                >
                  Update
                </button>
              </div>
              ...
              <div className="flex flex-col gap-5 items-center justify-center">
                ...
                <button
                  className="text-sm w-fit bg-red-500 px-10 py-3.5 rounded-2xl cursor-pointer hover:bg-red-600 hover:scale-101 shadow-sm hover:shadow-black/30 active:shadow-black/10 active:scale-98 transition-all duration-300 flex items-center gap-5"
      ...
      {loadingState ? (
        ...
        <div className="flex flex-col gap-2">
          ...
          <input
            type="text"
            placeholder="Enter certificate name"
            className="w-2/3 border border-gray-300 rounded-2xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-blue-500"
            id="certificate_name"
            name="certificate_name"
            value={formInput}
            onChange={(e) => setInput(e.target.value)}
